...
// Clase de utilidades(Conexión, Criterios de ordenación y conversiones)
...
public class MongoDB {
	...
	/*
	 * Método para establecer conexión con los parámetros establecidos en las
	 * constantes: BD = "reservasaulas"; USUARIO = "reservasaulas"; CONTRASENA =
	 * "reservasaulas-2022"; SERVIDOR = "localhost"; PUERTO = 27017;
	 */
	...
	/*
	 * Obtenemos los atributos del objeto profesor pasado por parámetro y los
	 * añadimos al documento. Devolviendo un documento con los datos del profesor
	 */
	...
	// Criterio de ordenación: ascendente (1) o descendente (-1).
	public static Document getCriterioOrdenacionProfesor() {
		return new Document().append(CORREO, 1);
	}

	// Devolvemos un objeto profesor obteniendo los datos del documento
	...
	/*
	 * Obtenemos los atributos del objeto aula pasado por parámetro y los añadimos
	 * al documento Devolviendo un documento con los datos del aula
	 */
	...
	// Devolvemos un objeto aula obteniendo los datos del documento
	...
	/*
	 * Obtenemos los atributos del objeto reserva pasado por parámetro, valiendonos
	 * del operador instanceof para determinar el tipo de permanencia y los añadimos
	 * al documento Devolviendo un documento con los datos de la reserva
	 */
	...
	// Devolvemos un objeto reserva obteniendo los datos del documento
